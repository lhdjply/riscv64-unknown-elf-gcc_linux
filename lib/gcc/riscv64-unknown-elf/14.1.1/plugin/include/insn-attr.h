...
#define HAVE_ATTR_xt_restriction 1
extern enum attr_xt_restriction get_attr_xt_restriction (rtx_insn *);

#define HAVE_ATTR_xt_disabled 1
extern enum attr_xt_disabled get_attr_xt_disabled (rtx_insn *);
...
#define HAVE_ATTR_fp_vector_disabled 1
extern enum attr_fp_vector_disabled get_attr_fp_vector_disabled (rtx_insn *);

#define HAVE_ATTR_spec_restriction 1
extern enum attr_spec_restriction get_attr_spec_restriction (rtx_insn *);

#define HAVE_ATTR_spec_restriction_disabled 1
extern enum attr_spec_restriction_disabled get_attr_spec_restriction_disabled (rtx_insn *);
...
#define HAVE_ATTR_th_m_has_mcfg_op 1
extern enum attr_th_m_has_mcfg_op get_attr_th_m_has_mcfg_op (rtx_insn *);

#define HAVE_ATTR_rvm_mcfgm_op_idx 1
extern int get_attr_rvm_mcfgm_op_idx (rtx_insn *);
#define HAVE_ATTR_rvm_mcfgn_op_idx 1
extern int get_attr_rvm_mcfgn_op_idx (rtx_insn *);
#define HAVE_ATTR_rvm_mcfgk_op_idx 1
extern int get_attr_rvm_mcfgk_op_idx (rtx_insn *);
#define HAVE_ATTR_rvm_mcfgk_gpr_op_idx 1
extern int get_attr_rvm_mcfgk_gpr_op_idx (rtx_insn *);
#define HAVE_ATTR_emode 1
extern enum attr_emode get_attr_emode (rtx_insn *);

#define HAVE_ATTR_rvm_ebytes 1
extern int get_attr_rvm_ebytes (rtx_insn *);
...
#define HAVE_ATTR_mode_idx 1
extern int get_attr_mode_idx (rtx_insn *);
...
#define HAVE_ATTR_avl_type_idx 1
extern int get_attr_avl_type_idx (rtx_insn *);
#define HAVE_ATTR_vxrm_mode 1
extern enum attr_vxrm_mode get_attr_vxrm_mode (rtx_insn *);

#define HAVE_ATTR_frm_mode 1
extern int get_attr_frm_mode (rtx_insn *);
