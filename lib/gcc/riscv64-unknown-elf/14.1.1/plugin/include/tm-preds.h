/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/flow/./source/riscv/gcc/gcc/config/riscv/riscv.md'.  */
...
extern bool xt_const_uns16_arith_operand (rtx, machine_mode);
extern bool xt_uns16_arith_operand (rtx, machine_mode);
extern bool fpr_operand (rtx, machine_mode);
extern bool xt_mem_operand (rtx, machine_mode);
extern bool fpr_or_xt_mem_operand (rtx, machine_mode);
extern bool fpr_or_xt_mem_or_0_operand (rtx, machine_mode);
extern bool reg_or_no_nan_double_operand (rtx, machine_mode);
extern bool p_register_operand (rtx, machine_mode);
extern bool const_0_to_31_operand (rtx, machine_mode);
extern bool const_0_1023_operand (rtx, machine_mode);
extern bool const_exp_4_operand (rtx, machine_mode);
extern bool const_exp_8_operand (rtx, machine_mode);
extern bool insv32_operand (rtx, machine_mode);
extern bool insv64_operand (rtx, machine_mode);
extern bool reg_or_const_0_to_31_operand (rtx, machine_mode);
extern bool csr_address (rtx, machine_mode);
extern bool mem_operand_by_reg (rtx, machine_mode);
extern bool reg_or_mem_operand_by_reg (rtx, machine_mode);
extern bool reg_or_mem_operand_by_reg_or_0_operand (rtx, machine_mode);
...
{
  return c >= CONSTRAINT_r && c <= CONSTRAINT_xi;
}

static inline bool
insn_extra_memory_constraint (enum constraint_num c)
{
  return c >= CONSTRAINT_e && c <= CONSTRAINT_m;
}
...
{
  if (c >= CONSTRAINT_c01 && c <= CONSTRAINT_xp)
    return;
